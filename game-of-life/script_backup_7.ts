...
//         this.saveBeforeStart = true;
//     }

//     drawOrErase(mousePosition: { x: number, y: number }): void {
...
//         const [worldX, worldY] = getWorldPosition(mousePosition, cellSize);
//         isDrawMode = event.button === 0 && !world.getCell(worldX, worldY);
...
// function preventContextMenuInDrawEraseMode(event: MouseEvent) {
//     if (getTool() === "draw-erase-tool") {
...
// function startPauseButtonClicked(): void {
//     if (isRunning) {
//         isRunning = false;
//     } else {
//         if (world.saveBeforeStart) {
//             savedWorld = world;
//             world.saveBeforeStart = false;
//         }
//         isRunning = true;
//     }
//     const newText = isRunning ? "Anhalten" : "Starten";
//     document.getElementById("start-pause-button").textContent = newText;
//     (document.getElementById("next-button") as HTMLButtonElement).disabled = isRunning;
// }
...
//     if (world.saveBeforeStart || !savedWorld)
//         return;
//     world = savedWorld;
//     renderGrid();
// }
...
// function snapToGrid() {
//     const cellSizePlus1 = parseInt(cellSizeInput.value) + 1;
//     // snap.x = (offset.x % cellSizePlus1 + cellSizePlus1) % cellSizePlus1;
//     // snap.y = (offset.y % cellSizePlus1 + cellSizePlus1) % cellSizePlus1;
//     // console.log(snap);
// }
...
// let isRunning = false;
// let center = { x: Math.floor(chunkSize / 2), y: Math.floor(chunkSize / 2) };
// let world = new World();
// let savedWorld: World | null = null;
// let frameDelay = 0;
// let view = { x: 0, y: 0 };
// let viewWidth = 0;
// let viewHeight = 0;
